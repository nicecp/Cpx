 ...
 * @github https://github.com/walkor/mysql
 * @author walkor
 */
class Mysql
{
    ...
    public function getBindValues()
    {
        switch ($this->type) {
            ...
            default :
                throw new CpxException("type err");
        }
    }
    ...
    {
        if (!$this->from) {
            throw new CpxException('Cannot join() without from()');
        }
    ...
    {
        if (!$this->from) {
            throw new CpxException('Cannot join() without from() first.');
        }
    ...
    {
        if (!$this->cols) {
            throw new CpxException('No columns in the SELECT.');
        }
    ...
    protected function build()
    {
        ...
        throw new CpxException("type empty");
    }
